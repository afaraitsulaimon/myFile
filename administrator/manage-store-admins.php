...
<head>
	...
	<title>Manange Store admins</title>
...
<body>
		...
		<div class="container">
			<div class="row d-flex justify-content-around">
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 mt-4">
				            ...
				            <h1 class="text-center pt-4">MANAGE STORE ADMIN'S</h1>
	...
	<!-- MANAGE STORE ADMIN DISPLAY TABLE START FROM HERE  -->
		...
		<div class="container manage_storeAdmin">
          ...
          <form method="POST" action="<?php echo htmlentities($_SERVER['PHP_SELF'])?>" align='center'>
           	...
           	<select name="man_storeAdminDept" class="col-lg-4 col-md-4 col-sm-12 col-xs">
           		<option value="noSearch">Search by Dept</option>
           		<option value="allAdmins">ALL</option>
          	...
          	<input type="text" name="man_storeAdminName" placeholder="Search By name"class="col-lg-4 col-md-4 col-sm-12 col-xs">

          	

          	<button type="submit" name="man_storeAdminSearchFBut">Search</button>
          </form>
  ...
  <?php
     require_once("process-manage-store-admins.php");
     require_once("process-delete-users.php");
  ?>
